...
import 'package:MyRoyal/base/widgets/card/mutation_card.dart';
import 'package:MyRoyal/base/widgets/card/status_stock_card.dart';
                    ...
                    children: [
                      ...
                      Column(
                        children: [
                          GestureDetector(
                            onTap: () {
                              controller.traceSerialData.value.data?.stock
                                          ?.isNotEmpty ==
                                      true
