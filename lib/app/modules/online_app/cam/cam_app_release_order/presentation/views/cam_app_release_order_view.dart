...
class CamAppReleaseOrderView extends GetView<CamAppReleaseOrderController> {
  const CamAppReleaseOrderView({super.key});
  @override
                    ...
                    Expanded(
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          final time =
                              controller.formatTimeRelease(item.jamRelease);
